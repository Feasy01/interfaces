...
class ControllerParser:
    ...
    def dict_of_controllers()-> dict:
        ...
        for filename in os.listdir(directory_path):
            if filename.endswith("controller.py") and not filename.startswith("__"):
                ...
                for class_name, class_obj in classes:
                    if 'Controller' in class_name: class_dict[class_name] = class_obj 

        return class_dict
    
if __name__ == "__main__":
    print(ControllerParser.dict_of_controllers())